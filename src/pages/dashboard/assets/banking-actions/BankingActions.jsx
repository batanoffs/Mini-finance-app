    ...
    return (
        <EmptyCard title="Banking Actions" color="primary" className={styles.customBlockBottom}>
            <div className={styles.transactionBtns}>
                <ButtonTooltip text="Top up account" type="topUp" icon={faVault} onClick={toggleModal} />
                <ButtonTooltip text="Send money" type="send" icon={faMoneyBillTransfer} onClick={toggleModal} />
                <ButtonTooltip text="Request money" type="request" icon={faHandHoldingDollar} onClick={toggleModal} />
            </div>
